...
import { physicianId, siteUrl } from "./seo";
...
export const metadata: Metadata = {
  ...
  verification: { other: { "facebook-domain-verification": "bjfh7i9iin5phg2z2f7409wab6umt8" } },
};
    ...
    "@graph": [
      {
        "@type": "Physician",
        "@id": physicianId,
        name: "Dr. Kulwant Yadav",
        url: siteUrl,
        image: `${siteUrl}/dr-kulwant-yadav-portrait.png`,
        medicalSpecialty: "Internal Medicine",
        description: "Consultant in Internal Medicine serving adults in Bhiwadi.",
        telephone: "+91-92057-75932",
        address: {
          "@type": "PostalAddress",
          streetAddress: "H-226, Industrial Area, Near Ramphal Cinema",
          addressLocality: "Bhiwadi",
          postalCode: "301019",
          addressRegion: "Rajasthan",
          addressCountry: "IN",
        },
        hasMap: "https://maps.app.goo.gl/W9QHHQxRkA5bGasi7",
        sameAs: [
        ...
        areaServed: [
          ...
          { "@type": "AdministrativeArea", name: "Alwar" },
        ],
        knowsAbout: [
          "Diabetes",
          "Hypertension",
