...
export const metadata:Metadata=pageMetadata({title:"Conditions Treated by an Internal Medicine Doctor",description:"Explore adult medical conditions assessed by Dr. Kulwant Yadav in Bhiwadi, including diabetes, hypertension, fatty liver, kidney risk, asthma and related concerns.",path:"/conditions"});
...
export default function ConditionsHub(){return <main className="conditions-hub">
  ...
  <section className="hub-hero"><p className="eyebrow"><span/> Conditions treated</p><h1>Conditions treated in <em>Internal Medicine.</em></h1><p>Internal Medicine brings together symptoms, medical history, test results and connected risk across body systems. Explore a clinical group or open a detailed patient guide.</p></section>
