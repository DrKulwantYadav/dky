...
export const metadata:Metadata=pageMetadata({title:"Book an Appointment with Dr. Kulwant Yadav",description:"Request an Internal Medicine consultation with Dr. Kulwant Yadav at Gopinath Hospital in Bhiwadi. Appointment requests require confirmation from the clinic.",path:"/book-appointment"});

export default function BookAppointmentPage(){return <main className="booking-page">
  <JsonLd data={[medicalWebPageSchema({name:"Book an Appointment with Dr. Kulwant Yadav",description:"Request an Internal Medicine consultation with Dr. Kulwant Yadav at Gopinath Hospital in Bhiwadi. Appointment requests require confirmation from the clinic.",path:"/book-appointment",about:"Internal Medicine appointment"}),breadcrumbSchema([{name:"Home",path:"/"},{name:"Book appointment",path:"/book-appointment"}])]} />
