...
export default function AppointmentForm(){
  ...
  return <form className="appointment-form" onSubmit={submit}>
    ...
    <div className="field-grid">
      ...
      <label><span>Consultation mode *</span><select name="mode" required defaultValue=""><option value="" disabled>Select consultation mode</option><option>In-person consultation</option></select></label>
